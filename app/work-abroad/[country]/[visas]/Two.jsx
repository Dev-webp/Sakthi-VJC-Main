...
const countryVisaData = {
  "germany-work-permit": [
    {
      ...
      path: "/work-abroad/germany-work-permit/opportunity-card",
    },
    {
      name: "Job Seeker Visa",
      path: "/work-abroad/germany-work-permit/job-seeker-visa",
    },
    { name: "Blue Card", path: "/work-abroad/germany-work-permit/blue-visa" },
    {
      name: "Skilled Work Permit Visa",
      path: "/work-abroad/germany-work-permit/work-permit-visa",
    },
    {
      name: "Employment Visa",
      path: "/work-abroad/germany-work-permit/employment-visa",
    },
    {
      name: "Freelance Visa",
      path: "/work-abroad/germany-work-permit/freelance-visa",
    },
  ],
  "canada-work-permit": [
    {
      name: "Open Work Permit Visa",
      path: "/work-abroad/canada-work-permit/open-work-permit",
    },
    ...
    { name: "CANADA WORK PERMIT", path: "/migrate/canada/work-permit" },
    {
      ...
      path: "/pr-visas/canada-pr/canada-express-entry",
    },
  ],
  "usa-h1b-visa": [
  ...
  "australia-work-permit": [
    {
      name: "Temporary Skills 482 Visa",
      path: "/work-abroad/australia-work-permit/482-visa",
    },
    {
      name: "Employer 186 Visa",
      path: "/work-abroad/australia-work-permit/employer-186-visa",
    },
    {
      name: "Skilled Independent Work Visa Subclass 189",
      path: "/work-abroad/australia-work-permit/work-visa-subclass-189",
    },
    {
      name: "Skilled Nominated Visa Subclass 190",
      path: "/work-abroad/australia-work-permit/nomited-visa-subclass-190",
    },
    {
      name: "Working Holiday 417 Visa",
      path: "/work-abroad/australia-work-permit/working-holiday-417-visa",
    },
  ],
  "united-kingdom-work-permit": [
    {
      name: "Short Term Work Visa",
      path: "/work-abroad/united-kingdom-work-permit/uk-short-term-work-visa",
    },
    {
      name: "Long Term Work Visa",
      path: "/work-abroad/united-kingdom-work-permit/uk-long-term-work-visa",
    },
    {
      name: "Health and Care Worker Visa",
      path: "/work-abroad/united-kingdom-work-permit/uk-health-and-care-worker-visa",
    },
    {
      name: "Skilled Worker Visa",
      path: "/work-abroad/united-kingdom-work-permit/uk-skilled-worker-visa",
    },
    {
      name: "Tier 2 Visa",
      path: "/work-abroad/united-kingdom-work-permit/uk-tire-2-visa",
    },
    {
      name: "Tier 4 Visa",
      path: "/work-abroad/united-kingdom-work-permit/uk-tire-4-visa",
    },
  ],
  "denmark-work-permit": [
    {
      name: "Pay Limit Scheme Visa",
      path: "/work-abroad/denmark-work-permit/denmark-pay-limit-scheme-visa",
    },
    {
      name: "Positive List Visa",
      path: "/work-abroad/denmark-work-permit/denmark-positive-list-visa",
    },
    {
      name: "Trainee Visa",
      path: "/work-abroad/denmark-work-permit/denmark-trainee-visa",
    },
    {
      name: "Employment Visa",
      path: "/work-abroad/denmark-work-permit/denmark-employment-visa",
    },
  ],
  "dubai-work-permit": [
    {
      name: "Standard Work Visa",
      path: "/work-abroad/dubai-work-permit/dubai-standard-work-visa",
    },
    {
      name: "Green Visa",
      path: "/work-abroad/dubai-work-permit/dubai-green-visa",
    },
    {
      name: "Golden Visa",
      path: "/work-abroad/dubai-work-permit/dubai-golden-visa",
    },
...
const visaBackgroundImages = {
  ...
  "/work-abroad/australia-work-permit/employer-186-visa":
    "/Employer186Visa.jpg",
  "/work-abroad/australia-work-permit/work-visa-subclass-189":
    "/SkilledIndependentWorkVisaSubclass189.jpg",
  "/work-abroad/australia-work-permit/nomited-visa-subclass-190":
    "/SkilledNominatedVisaSubclass190.webp",
  "/work-abroad/australia-work-permit/working-holiday-417-visa":
    "/WorkingHoliday417Visa.jpg",

  "/work-abroad/united-kingdom-work-permit/uk-short-term-work-visa":
    "/ShortTermWorkVisa.webp",
  "/work-abroad/united-kingdom-work-permit/uk-long-term-work-visa":
    "/LongTermWorkVisa.jpg",
  "/work-abroad/united-kingdom-work-permit/uk-health-and-care-worker-visa":
    "/Healthcare.jpg",
  "/work-abroad/united-kingdom-work-permit/uk-skilled-worker-visa":
    "/ukskilled.jpg",
  ...
  "/work-abroad/united-kingdom-work-permit/uk-work-permit-visa":
    "/WorkPermitVisauk.jpeg",

  "/work-abroad/denmark-work-permit/denmark-pay-limit-scheme-visa":
    "/PayLimitSchemeVisa.jpg",
  "/work-abroad/denmark-work-permit/denmark-positive-list-visa":
    "/PositiveListVisadenmark.png",
  "/work-abroad/denmark-work-permit/denmark-trainee-visa":
    "/TraineeVisadenmark.webp",
  "/work-abroad/denmark-work-permit/denmark-employment-visa":
    "/EmploymentVisadenmark.jpg",

  "/work-abroad/dubai-work-permit/dubai-standard-work-visa":
    "/StandardWorkVisa.jpg",
  ...
  "/work-abroad/dubai-work-permit/dubai-work-permit-visa":
    "/WorkPermitVisauk.jpeg",
...
const WorkabroadCountry = () => {
  ...
  useEffect(() => {
    if (visas) {
      const matchedVisa = visasList.find(
        (v) => v.path === `/work-abroad/${country}/${visas}`
      );
      if (matchedVisa) {
